    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          <span className="inline-block py-1 px-4 rounded-full bg-emerald-100 text-emerald-700 text-sm font-bold tracking-wide mb-6">
            5+ YEARS OF EXPERIENCE
          </span>
          <h1 className="heading-font text-5xl md:text-7xl font-bold text-slate-900 mb-8 leading-tight">
            Uncle Blessing <span className="text-emerald-600">Research Institute</span>
          </h1>
          <p className="max-w-2xl mx-auto text-xl text-slate-600 mb-12">
            Academic, Market, and Business consultation services by a graduate of Federal University Oye Ekiti.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              <i className="fab fa-whatsapp text-2xl"></i> Order Service
            </a>
            <a
              href="#about"
